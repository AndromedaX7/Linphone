                ...
                if (call == mCall && State.Connected == state) {
                    ...
                    if (message != null && call.getErrorInfo().getReason() == Reason.Declined) {
                        ...
                        if (message.equals("Forbidden")) {
                            App.app().IsForbidden = true;
                        //  displayCustomToast("sip连接异常,请重新登录连接", Toast.LENGTH_SHORT);
//                            stopService(new Intent(ACTION_MAIN).setClass(CallOutgoingActivity.this, LinphoneService.class));
//                            startService(new Intent(ACTION_MAIN).setClass(CallOutgoingActivity.this, LinphoneService.class));
//                            startActivity(new Intent().setClass(CallOutgoingActivity.this, LoginDemoActivity.class).setData(getIntent().getData()));
//                            finish();
                        } else {
