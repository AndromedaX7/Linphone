...
public class LinphoneActivity extends AppCompatActivity implements OnClickListener, ContactPicked, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private ArrayList<Fragment> fragmentsCache=new ArrayList<>();

    private StatusFragment statusFragment;
    private TextView missedCalls, missedChats, tv_chat, tv_dialer, tv_history, tv_contacts;
    ...
    private ImageView cancel, img_chat, img_dialer, img_history, img_contacts;
...
//        }
    ...
    private void initButtons() {
        ...
        img_dialer = (ImageView) findViewById(R.id.img_dialer);
        ...
        tv_dialer = (TextView) findViewById(R.id.tv_dialer);
    ...
    private HashMap<FragmentsAvailable, Fragment> fragmentCache = new HashMap<>();
...
//                }
                fragment = fragmentCache.get(newFragmentType);
                if (fragment == null) {
                    this.fragment = new HistoryListFragment();
                    fragmentCache.put(newFragmentType,fragment);
                }
                break;
            case HISTORY_DETAIL:
...
//                checkAndRequestReadContactsPermission();
            ...
            case DIALER:
                ...
                if (extras == null) {
                    this.fragment.setInitialSavedState(dialerSavedState);
                }
                break;
            case SETTINGS:
...
//                fragment = new ChatListFragment();
    ...
    public void displayPhone() {
        changeCurrentFragment(FragmentsAvailable.PHONE, null);
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.history) {
            ...
            img_history.setImageResource(R.drawable.chat_pressed);
            tv_history.setTextColor(getResources().getColor(R.color.colorAccent));
            //           history_selected.setVisibility(View.VISIBLE);
//            LinphoneManager.getLc().resetMissedCallsCount();
//            displayMissedCalls(0);
        } else if (id == R.id.contacts) {
            changeCurrentFragment(FragmentsAvailable.CONTACTS_LIST, null);
            img_contacts.setImageResource(R.drawable.main_contact_pressed);
            tv_contacts.setTextColor(getResources().getColor(R.color.colorAccent));
//            contacts_selected.setVisibility(View.VISIBLE);
        } else if (id == R.id.dialer) {
            changeCurrentFragment(FragmentsAvailable.DIALER, null);
//            dialer_selected.setVisibility(View.VISIBLE);
            img_dialer.setImageResource(R.drawable.main_dial_pressed);
            tv_dialer.setTextColor(getResources().getColor(R.color.colorAccent));
        } else if (id == R.id.chat) {
            changeCurrentFragment(FragmentsAvailable.CHAT_LIST, null);
//            chat_selected.setVisibility(View.VISIBLE);
            img_chat.setImageResource(R.drawable.me_pressed);
    ...
    private void resetSelection() {
        ...
        img_dialer.setImageResource(R.drawable.main_dial);
        tv_dialer.setTextColor(getResources().getColor(R.color.colorgray));
        img_chat.setImageResource(R.drawable.me_default);
        tv_chat.setTextColor(getResources().getColor(R.color.colorgray));
        img_history.setImageResource(R.drawable.chat_default);
        tv_history.setTextColor(getResources().getColor(R.color.colorgray));
        img_contacts.setImageResource(R.drawable.main_contact);
        tv_contacts.setTextColor(getResources().getColor(R.color.colorgray));
    }
...
//		changeCurrentFragment(FragmentsAvailable.DIALER, extras);
    ...
    protected void onResume() {
        ...
        if (App.app().IsForbidden) {
            App.app().IsForbidden = false;
            if (lc != null) {
                lc.refreshRegisters();
            }

//            displayCustomToast("sip连接异常,请重新登录连接", Toast.LENGTH_LONG);
//            stopService(new Intent(ACTION_MAIN).setClass(LinphoneActivity.this, LinphoneService.class));
//            startService(new Intent(ACTION_MAIN).setClass(LinphoneActivity.this, LinphoneService.class));
//            startActivity(new Intent().setClass(LinphoneActivity.this, LoginDemoActivity.class).setData(getIntent().getData()));
//            finish();
            return;
        }
...
//        }
    ...
    public void initSideMenu() {
        ...
        //打开手势滑动
//        sideMenu.setDrawerLockMode(DrawerLayout.LOCK_MODE_UNLOCKED);
        ...
        sideMenuItems.add(getResources().getString(R.string.menu_phone));
        ...
        sideMenuItemList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (sideMenuItemList.getAdapter().getItem(i).toString().equals(getString(R.string.menu_phone))) {
                    LinphoneActivity.instance().displayPhone();
                }
                if (getResources().getBoolean(R.bool.enable_in_app_purchase)) {
    ...
    public void updateSystem() {
        ...
        webServer.checkUpdate(new MyCallBack<String>() {
            ...
            public void onSuccess(String result) {
                ...
                int vercode = Config.getVerCode(LinphoneActivity.this);
                try {
                    if (!TextUtils.isEmpty(result)) {
                        ...
                        if (newVerCode > vercode) {
                            updateApk(LinphoneActivity.this, versionInfo, newVerName, isForce, true, 10000000, versonURL, LinphoneActivity.this.getResources().getString(R.string.app_name));
                        }
                    }
                } catch (Exception e) {
